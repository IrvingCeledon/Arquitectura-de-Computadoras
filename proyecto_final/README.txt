Este proyecto final consta de 2 partes:
  - Un decodificador de instrucciones MIPS 32 (tipo R, I y J) a binario.
...
La relación entre estas dos partes, se encuentra en como el decodificador recibe un conjunto de instrucciones que emulan el algortimo de Bubble Sort, para transformarlo a binario en un formato Big Endian de 8 bits. Esto para que el pipeline, pueda interpretar las instrucciones y llevar a cabo el algoritmo.
